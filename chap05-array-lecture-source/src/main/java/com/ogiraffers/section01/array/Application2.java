...
//        iArr = new int[];                                    // 베열은 반드시 크기를 할당해주어야 함
        iArr = new int[10];
        ...
        System.out.println("iArr = " + iArr.hashCode());       // 주소를 10진수로 변경
        System.out.println("cArr = " + cArr.hashCode());

        /* 필기. null값을 지닌 참조 자료형 변수(아무것도 참조하지 않을 때)를 접근 시 발생하는 에러 확인 */
        cArr = null;
        System.out.println("null을 참조할 시: " + cArr.hashCode());  // .NullPointerException 오류명
    }
}
